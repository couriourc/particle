window.loader_stuck = setInterval(function() {
    location.reload()
}, 3e4)
$(function () {
    function e() {
...
//            Et.sand.play(),
    ...
    function a(e, t, a, n) {
        ...
        125 > d && (u.left = "125px"),
            ...
            clearTimeout($.data(window.document, "wait")),
            $.data(
                window.document,
                "wait",
                setTimeout(function () {
        ...
        switch (_t) {
            ...
            case "round":
                1 == Wt && $("#round_tip").css("display", "table"),
                    ...
                    $.getJSON("php/get_stories.php", {}, function (e) {
